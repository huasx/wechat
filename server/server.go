...
type Server struct {
	*context.Context
	...
	messageHandler func(ctx *context.Context) *message.Reply

	requestRawXMLMsg  []byte
	requestMsg        message.BaseMessage
...
func (srv *Server) SetSafeModel(val bool) {
	srv.isSafeMode = val
}
...
func (srv *Server) handleRequest() (reply *message.Reply, err error) {
	...
	mixMessage, success := msg.(message.BaseMessage)
	if !success {
...
func (srv *Server) getMessage() (interface{}, error) {
	...
	srv.Context.RequestRawXMLMsg = rawXMLMsgBytes
	return srv.parseRequestMessage(rawXMLMsgBytes)
}

func (srv *Server) parseRequestMessage(rawXMLMsgBytes []byte) (msg message.BaseMessage, err error) {
...
func (srv *Server) SetMessageHandler(handler func(c *context.Context) *message.Reply) {
